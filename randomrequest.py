...
PATH = "/var/www/html"
JARS_DIR = PATH + "/jars"
GAMES_PATH = PATH + "/BattleShipServer/logs/games.log"
...
def main():
  ...
  for k in sortable_results:
    ...
    with open(REQUEST_PATH, "a") as f:
      for n in range(min(2, len(sortable_results[k]))):
        f.write("{} {}.jar {}.jar\n".format(AUTO_USERNAME, k, sortable_results[k][n][0]))
